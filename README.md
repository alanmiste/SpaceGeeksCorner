...
<br>
This video serves as a temporary solution, allowing visitors to quickly view and experience the app without the need to clone the repository or install any libraries. <br>
[Click here to view the video](https://youtu.be/Vfjd2eig3BU)
<br>
