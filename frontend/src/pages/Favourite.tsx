...
export default function Favourite(props: FavouriteProps) {
    ...
    const filteredUserItems = props.userItemsList.filter(
        item => item.username.includes(props.me))
    return <>
        <Header me={props.me}/>
        <p>you are in Favourite</p>
        <CardsList filteredNasaData={filteredUserItems} me={props.me}
                   addItem={props.addItem} favouriteBtnDisplay={true} userItemsList={props.userItemsList}/>
    </>
}
